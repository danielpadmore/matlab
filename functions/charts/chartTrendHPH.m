...
function [ chart ] = chartTrendHPH( inputData, xlabels, target, name )
...
% appropriate
if numel(inputData) >= 50
    error('Too many elements in data input, use more suitable chart')
end
